                            ...
                            <Col md={4} xs={6}>
                                <Label>
                                    ...
                                    <Select disabled={btnFlag == 2}
                                        {
                                        ...getFieldProps('unit', {
                                            initialValue: typeof unit === 'undefined' ? "" : unit ,
                                            rules: [{
                                ...
                                <Label>
                                    ...
                                    <Select disabled={btnFlag == 2}
                                        ...
                                        ...getFieldProps('categoryname', {
                                            initialValue: typeof categoryname === 'undefined' ? "" : categoryname ,
                                            rules: [{
                                ...
                                <Label>
                                    ...
                                    <Select disabled={btnFlag == 2}
                                        ...
                                        ...getFieldProps('category', {
                                            initialValue: typeof category === 'undefined' ? "" : category ,
                                            rules: [{
