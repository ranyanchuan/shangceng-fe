...
class Quote extends Component {
    ...
    render() {
        const _this = this;
        const {partObj, quoteIndex, partIndex, quoteList, ppdesignCenter, ppcusaddress, pid, otherParts} = _this.props;
                    ...
                    <Row>
                        <Col md={4} xs={12} sm={12}>
                            ...
                            <div className="create-part">
                                <Part partObj={partObj} pid={pid} partIndex={partIndex} otherParts={otherParts}/>
                            </div>
                        </Col>
